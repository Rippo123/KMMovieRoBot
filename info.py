...
BOT_TOKEN = environ.get('BOT_TOKEN','6229399507:AAFQ6GvM53XXrORQQHDfZWEF157uk211Fds')
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', ' -1001972003475').split()]
